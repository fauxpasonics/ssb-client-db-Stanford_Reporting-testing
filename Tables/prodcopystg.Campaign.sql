...
[CopyLoadDate] [datetime] NULL CONSTRAINT [DF_ProdCopy_Campaign] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Campaign] ADD CONSTRAINT [PK__Campaign__3214EC07AC983747] PRIMARY KEY CLUSTERED  ([Id])
GO
