...
[CopyLoadDate] [datetime] NULL CONSTRAINT [DF_ProdCopy_Account] DEFAULT (getdate()),
...
GO
ALTER TABLE [prodcopystg].[Account] ADD CONSTRAINT [pk_id] PRIMARY KEY CLUSTERED  ([Id])
GO
