...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF__Contact__CopyLoa__1ED998B2] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Contact] ADD CONSTRAINT [pk_id_contactstg] PRIMARY KEY CLUSTERED  ([Id])
GO
