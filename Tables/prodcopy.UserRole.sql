...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF__UserRole__CopyLo__35BCFE0A] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[UserRole] ADD CONSTRAINT [PK_ProdCopy_UserRole] PRIMARY KEY CLUSTERED  ([Id])
GO
