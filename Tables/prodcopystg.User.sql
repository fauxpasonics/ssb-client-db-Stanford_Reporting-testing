...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF_ProdCopy_User] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[User] ADD CONSTRAINT [PK__User__3214EC0737C10D1C] PRIMARY KEY CLUSTERED  ([Id])
GO
