...
[Basis__c] [nvarchar] (32) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[Orig_Salecode_Name__c] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[Promo_Code_Name__c] [nvarchar] (128) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF_ProdCopy_Transaction__c] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Transaction__c] ADD CONSTRAINT [PK__Transact__3214EC070C0F615F] PRIMARY KEY CLUSTERED  ([Id])
GO
