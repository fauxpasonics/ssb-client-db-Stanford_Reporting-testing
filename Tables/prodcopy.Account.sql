...
[CopyLoadDate] [datetime] NULL CONSTRAINT [DF__Account__CopyLoa__73BA3083] DEFAULT (getdate()),
[SSB_CRMSYSTEM_APIID__c] [nvarchar] (1300) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[SSB_CRMSYSTEM_APIID__pc] [nvarchar] (1300) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[SSB_CRMSYSTEM_Season_Ticket_Years__c] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[suffix__c] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Contact_Service_Owner__pc] [nvarchar] (18) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[DialSource__DS_Owner_ID__pc] [nvarchar] (1300) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[DialSource__Last_Call_Campaign_Name__pc] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[SSB_CRMSYSTEM_SSID_Winner_SourceSystem__c] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
)
GO
ALTER TABLE [prodcopy].[Account] ADD CONSTRAINT [PK_ProdCopy_Account] PRIMARY KEY CLUSTERED  ([Id])
GO
CREATE NONCLUSTERED INDEX [IDX_ProdCopy_Account_ACCTGUID] ON [prodcopy].[Account] ([SSB_CRMSYSTEM_Contact_ID__c])
GO
