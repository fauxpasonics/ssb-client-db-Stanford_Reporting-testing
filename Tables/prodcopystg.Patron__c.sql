...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Patron__c__copyl__03F0984C] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Patron__c] ADD CONSTRAINT [PK__Patron____3214EC07027FC7C7] PRIMARY KEY CLUSTERED  ([Id])
GO
