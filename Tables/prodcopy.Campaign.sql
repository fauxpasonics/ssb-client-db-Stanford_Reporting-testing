...
[CopyLoadDate] [datetime] NULL CONSTRAINT [DF__Campaign__CopyLo__15502E78] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[Campaign] ADD CONSTRAINT [PK_ProdCopy_Campaign] PRIMARY KEY CLUSTERED  ([Id])
GO
