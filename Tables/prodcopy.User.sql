...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [DF__User__CopyLoadDa__37A5467C] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[User] ADD CONSTRAINT [PK_ProdCopy_User] PRIMARY KEY CLUSTERED  ([Id])
GO
